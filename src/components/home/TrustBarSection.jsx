        ...
        {items.map((item, i) => (
          <React.Fragment key={item.title}>
            <div className="flex items-center gap-3 flex-1">
              <div className="w-16 h-16 bg-custom-green-500 rounded-full flex items-center justify-center flex-shrink-0 overflow-hidden">
                <img src={item.icon} alt="" className="w-14 h-14 object-contain" style={{ mixBlendMode: 'screen' }} />
              </div>
              <div>
