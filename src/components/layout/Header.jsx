...
import {
  ...
  ShieldCheck, Wallet, KeyRound, ChevronDown, Facebook, Instagram, Music, Store, Megaphone,
} from 'lucide-react';
      ...
      <div className="bg-custom-green-500 text-white text-[12px] font-medium hidden lg:block">
        <div className="max-w-[1280px] mx-auto px-6 py-2 flex items-center justify-between">
          ...
          <div className="flex items-center gap-2.5">
            ...
            <div className="w-px h-3.5 bg-white/25" />
            <a href="https://chat.whatsapp.com/CgRPcdLTGVcFVn3JLh4SHh?s=cl&p=i&mlu=4&ilr=4" target="_blank" rel="noopener noreferrer"
              title="Rejoindre le groupe WhatsApp"
              className="w-[22px] h-[22px] bg-white/15 rounded flex items-center justify-center hover:bg-white/25 transition-colors">
              <WhatsAppIcon />
            </a>
            <a href="https://whatsapp.com/channel/0029VbDPhv7DJ6Gs1Z38e924" target="_blank" rel="noopener noreferrer"
              title="Suivre la chaîne WhatsApp"
              className="w-[22px] h-[22px] bg-white/15 rounded flex items-center justify-center hover:bg-white/25 transition-colors">
